...
export default function ServerSideBar({setActiveView,activeView,currentServer,setShowCreateLobbyModal,setSelectedLobbyName,setSelectedLobby,selectedLobby,lobbies,setConfirmModalOpen,setOpen,currentUser,getInitials}:any){
    return(
